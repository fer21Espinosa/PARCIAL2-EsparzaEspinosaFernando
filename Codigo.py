...
#esta funcion sirve para guardar una matriz en el archivo csv pero en este caso se quedo en fase prueba
def IngresarMatriz(data):
      with open('Datos_Ejemplos.csv', 'w') as csvfile:
          writer = csv.writer(csvfile, delimiter=',')
          writer.writerows(data)

def leerMatriz():
    reader=csv.reader(open('Datos_Ejemplo.csv', "r"),delimiter=',')
    listR=list(reader)
